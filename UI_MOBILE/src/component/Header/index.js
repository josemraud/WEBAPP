...
class Header extends React.Component {
  ...
  renderStatusBar() {
    if (this.props.showStatusBar) {
      if (this.props.statusBarType === 'light') {
        return <StatusBar backgroundColor='#de6624' barStyle='dark-content' />
      } else if (this.props.statusBarType === 'dark') {
        return <StatusBar backgroundColor='#de6624' barStyle='light-content' />
      }
    }
  ...
  renderNavLeft() {
    ...
    let icon
    if (this.props.navLeftContent === 'prin') {
      ...
      icon = <TouchableOpacity style={theme.btnTransparent} onPress={back}>
        <Icon name='arrow-left' type='Feather' style={theme.light} />
      </TouchableOpacity>
    } else if (this.props.navLeftType === 'menu') {
      icon = <TouchableOpacity style={theme.btnTransparent} onPress={openDrawer}>
        <Icon name='align-left' type='Feather' style={theme.light} />
      </TouchableOpacity>
    }
  ...
  renderNavRight() {
    ...
    if (this.props.navRightContent) {
      ...
      icon = <TouchableOpacity onPress={() => { navigate('PublicPropertyDetail') }}>
