...
getAllCiudades = (id_region) => {
  ciudadesservice.getAllCiudades(id_region).then(({ data }) => {
    ...
    getbusqueda() {
    bienesservice.getbusqueda(id_ciudad,id_tipo_bien,menorf,mayorf).then(({ data }) => {
